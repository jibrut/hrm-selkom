    ...
    d.app.menu = {
        ...
        manualScroller: {
                ...
                if (this.obj) {
                    ...
                    if (!0 === d(".main-menu").data("scroll-to-active"))
                        ...
                        setTimeout(function() {
                            ...
                            d(".main-menu").data("scroll-to-active", "false")
                        }, 300);
                    this.obj.update()
                }
            },
            ...
            updateHeight: function() {
                "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || (d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height() - d(".main-menu-header").outerHeight() - d(".main-menu-footer").outerHeight()),
                this.update())
            }
        },
        init: function(e) {
            if (0 < d(".main-menu-content").length) {
                ...
                "vertical-menu-modern" == l.data("menu")) {
                    var a = "";
                    "undefined" != typeof Storage && (a = localStorage.getItem("menuLocked")),
                    "false" === a ? this.change("collapsed") : this.change()
                } else
                    this.change(n)
            } else
                this.drillDownMenu()
        ...
        change: function(e) {
            ...
            "xl" == n.name && (d('body[data-open="hover"] .dropdown').on("mouseenter", function() {
            ...
            d('body[data-open="hover"] .dropdown a').on("click", function(e) {
                if ("horizontal-menu" == s && d(this).hasClass("dropdown-toggle"))
                    return !1
            })),
            ...
            d("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) {
                0 < d(this).siblings("ul.dropdown-menu").length && e.preventDefault(),
                e.stopPropagation(),
                d(this).parent().siblings().removeClass("show"),
                d(this).parent().toggleClass("show")
            }),
            ...
            "vertical-menu" !== s && "vertical-overlay-menu" !== s || (jQuery.expr[":"].Contains = function(e, n, a) {
            ...
            d(i).change(function() {
                ...
                if (e) {
                    ...
                    d(a).find("li a:not(:Contains(" + e + "))").hide().parent().hide();
                    var n = d(a).find("li a:Contains(" + e + ")");
                    n.parent().hasClass("has-sub") ? (n.show().parents("li").show().addClass("open").closest("li").children("a").show().children("li").show(),
                    0 < n.siblings("ul").length && n.siblings("ul").children("li").show().children("a").show()) : n.show().parents("li").show().addClass("open").closest("li").children("a").show()
                } else
                    d(".navigation-header").show(),
        ...
        transit: function(e, n) {
            ...
            e.call(a),
            l.hasClass("vertical-layout") && (l.hasClass("menu-open") || l.hasClass("menu-expanded") ? (d(".menu-toggle").addClass("is-active"),
            "vertical-menu" === l.data("menu") && d(".main-menu-header") && d(".main-menu-header").show()) : (d(".menu-toggle").removeClass("is-active"),
            "vertical-menu" === l.data("menu") && d(".main-menu-header") && d(".main-menu-header").hide())),
            setTimeout(function() {
                n.call(a),
                l.removeClass("changing-menu"),
                a.update()
            }, 500)
        },
        open: function() {
            this.transit(function() {
                l.removeClass("menu-hide menu-collapsed").addClass("menu-open"),
                this.hidden = !1,
                this.expanded = !0
            }, function() {
        ...
        expand: function() {
            !1 === this.expanded && ("vertical-menu-modern" == l.data("menu") && (d(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-circle").addClass("ft-disc"),
            "undefined" != typeof Storage && localStorage.setItem("menuLocked", "true")),
            this.transit(function() {
                l.removeClass("menu-collapsed").addClass("menu-expanded"),
                this.collapsed = !1,
                this.expanded = !0
            }, function() {
                ...
                "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height() - d(".main-menu-header").outerHeight() - d(".main-menu-footer").outerHeight())
            }))
        },
        collapse: function(e) {
            !1 === this.collapsed && ("vertical-menu-modern" == l.data("menu") && (d(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-disc").addClass("ft-circle"),
            "undefined" != typeof Storage && localStorage.setItem("menuLocked", "false")),
            this.transit(function() {
                l.removeClass("menu-expanded").addClass("menu-collapsed"),
                this.collapsed = !0,
                this.expanded = !1
            }, function() {
                "horizontal-menu" == l.data("menu") && l.hasClass("vertical-overlay-menu") && d(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || (d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height()),
                d(".main-menu-content").hasClass("ps") || this.manualScroller.enable())
            }))
        },
        ...
        changeMenu: function(e) {
            d('div[data-menu="menu-wrapper"]').html(""),
            d('div[data-menu="menu-wrapper"]').html(r);
            var n = d('div[data-menu="menu-wrapper"]')
              , a = (d('div[data-menu="menu-container"]'),
            d('ul[data-menu="menu-navigation"]'))
              , i = d('li[data-menu="megamenu"]')
              , s = d("li[data-mega-col]")
              , t = d('li[data-menu="dropdown"]')
              , o = d('li[data-menu="dropdown-submenu"]');
            "sm" == e || "xs" == e ? (l.removeClass(l.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"),
            ...
            s.each(function(e, n) {
                ...
                a.is("h6") && (i = a.html(),
                a.remove(),
                d(n).prepend('<a href="#">' + i + "</a>").addClass("has-sub mega-menu-title"))
            }),
            ...
            d("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                d(this).parent().siblings().removeClass("open"),
                d(this).parent().toggleClass("open")
        ...
        reset: function() {
            ...
            this.collapsed = !1,
            this.hidden = !1,
            l.removeClass("menu-hide menu-open menu-collapsed menu-expanded")
        }
    },
    d.app.nav = {
        ...
        bind_events: function() {
            ...
            d(".navigation-main").on("mouseenter.app.menu", "li", function() {
                var e = d(this);
                if (d(".hover", ".navigation-main").removeClass("hover"),
                l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu")) {
                    d(".main-menu-content").children("span.menu-title").remove(),
                    d(".main-menu-content").children("a.menu-title").remove(),
                    d(".main-menu-content").children("ul.menu-content").remove();
                    var n, a, i = e.find("span.menu-title").clone();
                    e.hasClass("has-sub") || (n = e.find("span.menu-title").text(),
                    a = e.children("a").attr("href"),
                    "" !== n && ((i = d("<a>")).attr("href", a),
                    i.attr("title", n),
                    i.text(n),
                    i.addClass("menu-title")));
                    var s, t = d(".navbar-header").length ? d(".navbar-header").height() : 0;
                    if (s = e.css("border-top") ? t + e.position().top + parseInt(e.css("border-top"), 10) : t + e.position().top,
                    i.appendTo(".main-menu-content").css({
                        position: "fixed",
                        top: s
                    }),
                ...
                if (n.addClass("open"),
                o.expand(n),
                d(".main-menu").hasClass("menu-collapsible"))
                    return !1;
                n.siblings(".open").find("li.open").trigger("close.app.menu"),
                n.siblings(".open").trigger("close.app.menu"),
                e.stopPropagation()
                ...
                var n = d(this);
                n.is(".disabled") ? e.preventDefault() : l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu") ? e.preventDefault() : n.has("ul") ? n.is(".open") ? n.trigger("close.app.menu") : n.trigger("open.app.menu") : n.is(".active") || (n.siblings(".active").trigger("deactive.app.menu"),
                n.trigger("active.app.menu")),
                e.stopPropagation()
            }),
            d(".navbar-header, .main-menu").on("mouseenter", function() {
                if ("vertical-menu-modern" == l.data("menu") && (d(".main-menu, .navbar-header").addClass("expanded"),
                ...
                l.hasClass("menu-collapsed") && "vertical-menu-modern" == l.data("menu") && setTimeout(function() {
                    if (0 === d(".main-menu:hover").length && 0 === d(".navbar-header:hover").length && (d(".main-menu, .navbar-header").removeClass("expanded"),
                    l.hasClass("menu-collapsed"))) {
            ...
            d(".main-menu-content").on("mouseleave", function() {
                l.hasClass("menu-collapsed") && (d(".main-menu-content").children("span.menu-title").remove(),
                d(".main-menu-content").children("a.menu-title").remove(),
                d(".main-menu-content").children("ul.menu-content").remove()),
            ...
            d("ul.menu-content").on("click", "li", function(e) {
                ...
                if (n.is(".disabled"))
                    ...
                    n.is(".active") || (n.siblings(".active").trigger("deactive.app.menu"),
                    n.trigger("active.app.menu"));
                e.stopPropagation()
            })
        },
        ...
        collapse: function(e, n) {
            e.children("ul").show().slideUp(d.app.nav.config.speed, function() {
                d(this).css("display", ""),
                d(this).find("> li").removeClass("is-shown"),
                n && n(),
                d.app.nav.container.trigger("collapsed.app.menu")
            })
        },
        expand: function(e, n) {
            var a = e.children("ul")
            ...
            a.hide().slideDown(d.app.nav.config.speed, function() {
                d(this).css("display", ""),
                n && n(),
                d.app.nav.container.trigger("expanded.app.menu")
            }),
            setTimeout(function() {
                i.addClass("is-shown"),
